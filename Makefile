...
coverage: ## check code coverage quickly with the default Python
	coverage run --source corona_chan_gob_mx setup.py test
	coverage report -m
	coverage html
	$(BROWSER) coverage_html_report/index.html

docs: ## generate Sphinx HTML documentation, including API docs
	rm -f docs/corona_chan_gob_mx.rst
	rm -f docs/modules.rst
	sphinx-apidoc -o docs/ corona_chan_gob_mx
	$(MAKE) -C docs clean
	$(MAKE) -C docs html
...
flakes:
	...
	@pyflakes corona_chan_gob_mx tests
